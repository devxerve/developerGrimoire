...
# :dev_java_original:Polimorfismo
...
> Metodos con el mismo nombre pero diferentes parámetros dentro de la misma clase, Java elige los parámetros según lo que pongamos nosotros, similar a [[Constructores Java#Sobrecarga de constructores|la sobrecarga de constructores]]
> 
...
> Clase hija reescribe el método de la superclase ([[Inheritance and Polimorfism Java#Herencia|Herencia]]) con la anotación @Override
